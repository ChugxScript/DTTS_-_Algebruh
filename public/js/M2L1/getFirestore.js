...
export const getEasyQuestionsFromFirestore = async () => {
    const easyQuestionsRef = doc(db, 'stageQuestions', 'module2Lecture1');
...
export const getDifficultQuestionsFromFirestore = async () => {
    const difficultQuestionsRef = doc(db, 'stageQuestions', 'module2Lecture1');
...
export const getBonusFromFirestore = async () => {
    const bonusRef = doc(db, 'stageQuestions', 'module2Lecture1');

...
export const getEasyQuestionsFromFirestore = async () => {
    const easyQuestionsRef = doc(db, 'stageQuestions', 'module7Lecture2');
...
export const getDifficultQuestionsFromFirestore = async () => {
    const difficultQuestionsRef = doc(db, 'stageQuestions', 'module7Lecture2');
...
export const getBonusFromFirestore = async () => {
    const bonusRef = doc(db, 'stageQuestions', 'module7Lecture2');
